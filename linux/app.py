...
class App:
	...
	def process_model(self, directory_path, model_name, sheet=False, burn=False, delete=False):
	    ...
	    current_files = []
	    self.process_segments_for_model(video_files, current_files, model_name, directory_path, delete, sheet, burn, couldn_merge_directory)

	    _end_time = time.time()
	    _elapsed_time = _end_time - _start_time

	    _time_formatted = self._time_utils.format_time(TimeFormat.HMS)
